 ...
 */
public class CustomStandardAlgorithms extends AlgorithmProvider {

	/**
	 * Constructs the standard algorithm provider.
	 */
	public CustomStandardAlgorithms() {
		super();
	}
	...
	private Initialization getInitialization(Problem problem, int populationSize) {
		Initialization initialization = new CustomInitialization(problem,
				populationSize);
	...
	private Algorithm newRandomSearch(TypedProperties properties, 
		...
		Initialization generator = getInitialization(problem, populationSize);
